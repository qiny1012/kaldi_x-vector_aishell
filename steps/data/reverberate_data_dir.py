...
def parse_rir_list(rir_set_para_array, smoothing_weight, sampling_rate = None):
    ...
    rir_parser.add_argument('rir_rspecifier', type=str, help="""rir rspecifier, it can be either a filename or a piped command. E.g. data/impulses/Room001-00001.wav or "sox data/impulses/Room001-00001.wav -t wav - |" """)
        ...
        for rir in current_rir_list:
            ...
            if sampling_rate is not None:
                ...
                if len(rir.rir_rspecifier.split()) == 1:
                    rir.rir_rspecifier = "sox /home/qinyc/openSLR/SLR28_rir/{0} -r {1} -t wav - |".format(rir.rir_rspecifier, sampling_rate)
                else:
